...
//TODO: another approach for discovering the leader:
// The cluster sends a leader change message to a queue (this way it doesn't know the clients) or to the clients
// The clients change their knowledge of the current leader after receiving this message.
